<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="电话" align="center" prop="supplierPhonenumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="电话" prop="supplierPhonenumber">
          <el-input v-model="form.supplierPhonenumber" placeholder="请输入电话" />
        </el-form-item>
      </el-form>
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier, exportSupplier } from "@/api/system/supplier";
